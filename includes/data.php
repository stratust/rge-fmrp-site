...
// ── NOTÍCIAS ──────────────────────────────────────────────
$NOTICIAS = [
    ['data'=>'20 MAI 2025','categoria'=>'PESQUISA','titulo'=>'Estudo revela novo mecanismo genético em doenças raras neurológicas','resumo'=>'Pesquisadores do Departamento de Genética da FMRP/USP identificaram vias celulares inéditas envolvidas no desenvolvimento de doenças genéticas neurológicas raras. O estudo abre caminho para novas estratégias terapêuticas e diagnóstico precoce.','imagem'=>'https://images.unsplash.com/photo-1532187863486-abf9dbad1b69?w=400&h=250&fit=crop'],
    ['data'=>'15 JUN 2026','categoria'=>'EVENTO','titulo'=>'Jéssica Oliveira de Santis — Doutorado','resumo'=>'Defesa de tese: Caracterização Molecular e Abordagens Funcionais para Identificação de Vulnerabilidades Terapêuticas no Meduloblastoma Pediátrico.','imagem'=>'https://images.unsplash.com/photo-1544531586-fde5298cdd40?w=400&h=250&fit=crop'],
    ...
    ['data'=>'05 MAI 2025','categoria'=>'PUBLICAÇÃO','titulo'=>'Novo artigo publicado em revista internacional','resumo'=>'Trabalho da equipe de genética molecular é destaque na revista Genetics & Development.','imagem'=>'https://images.unsplash.com/photo-1628595351029-c2bf17511435?w=400&h=250&fit=crop'],
